...
//build the truncate sql query string
$sql="TRUNCATE TABLE " . $table;

//execute the truncate query and report back status in xml form
...
//execute the insert query and report back status in xml form
echo "<insert>";
echo "<sql>" . $sql . "</sql>";
if (!mysql_query($sql,$conn)){
	die('<result>' . mysql_error() . "</result>");
